  ...
  return (
    <div aria-label="Website Homepage">
      ...
      <div className="container mx-auto py-12">
        <h2 className="border-l-4 border-gray-400 px-5 uppercase font-heading text-3xl mb-4">
          What makes Caffinity so special?
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-8 text-base">
          <div>
            <div className="bg-gray-400 rounded-full max-w-fit p-4 mb-5">
              <svg
            ...
            <h3 className="text-2xl font-bold mb-3">Organic Beans</h3>
            <p>
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold mb-3">Perfect Processing</h3>
            <p>
