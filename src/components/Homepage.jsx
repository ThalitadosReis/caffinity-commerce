export default function Homepage() {
  return (
    <div
      ...
      className="space-y-5 text-white container mx-auto"
    >
      {/* banner section */}
      <div className="lg:h-[500px] flex flex-col lg:flex-row items-center space-x-5 ">
        <div className="lg:w-5/12 h-full bg-stone-800 rounded-3xl flex flex-col justify-between p-5">
      ...
      {/* about section */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5 content-center text-base bg-stone-500 rounded-3xl p-9">
        <div className="flex flex-col items-center">
          ...
          <span className="text-md">Free Shipping & Returns</span>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-md">Organic Beans</span>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-md">Fair Trade</span>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-md">High quality product</span>
        </div>
      </div>
    </div>
  );
